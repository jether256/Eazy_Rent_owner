...
List<HouseModel> businessFromJson(String str) =>
    List<HouseModel>.from(json.decode(str).map((x) => HouseModel.fromJson(x)));

String businessToJson(List<HouseModel> data) =>
...
class HouseModel {
  ...
  HouseModel( {required this.proi,required this.ID, required this.u_id, required this.own, required this.phon, required this.biz, required this.num, required this.mail, required this.img1, required this.img2, required this.img3,
  ...
  factory HouseModel.fromMap(Map<String, dynamic> json) {
    return   HouseModel(
      ID:json['ID'],
      u_id:json['user_id'],
      own:json['owner'],
