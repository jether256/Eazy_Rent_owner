...
class _WareHouseListState extends State<WareHouseList> {
  ...
  Future showHouse() async {
    ...
    try{
      ...
      var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/warehouse/getRent.php'),
          body:{'user_id':'$userID'});
            ...
            if(data.contains('empty')){
              ...
              return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No warehouses Uploaded',style: TextStyle(color: Colors.grey,fontSize: 14),),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Text('Add Ware House',style: TextStyle(color: Colors.white),),
                          ],
                        ),
                      ),
                    ),
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>EditWareHouse(
...
void Delete(String s) async{
 ...
 // EasyLoading.show(status: 'Deleting .....');
  ...
  var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/warehouse/delete.php'),
      headers: {"Accept": "headers/json"},
      body:{"pro_id":s});

  if(response.statusCode==200){

    EasyLoading.showSuccess('Ware House deleted...');
