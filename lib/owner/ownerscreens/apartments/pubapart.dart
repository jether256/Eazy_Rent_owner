...
import 'addapart.dart';
import 'apartdetail.dart';
import 'editapart.dart';
...
class _ApartmentListState extends State<ApartmentList> {
  ...
  Future showHouse() async {
    ...
    try{
      ...
      var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/apartment/getRent.php'),
          body:{'user_id':'$userID'});
  ...
  //       Uri.parse("https://eazyrent.000webhostapp.com/api/owner/businesses/rental/getRent.php"),
            ...
            if(data.contains('empty')){
              ...
              return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No Apartments Uploaded',style: TextStyle(color: Colors.grey,fontSize: 14),),
                    ...
                    NeumorphicButton(
                      onPressed: (){
                        ...
                        Navigator.pushReplacementNamed(context,AddApart.id);
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Text('Add Apartment',style: TextStyle(color: Colors.white),),
                          ],
                        ),
                      ),
                    ),
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        DataCell(
                          InkWell(
                            onTap: (){
                              ...
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>ApartmentDetail(
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>EditApartment(
                                  Id:'${e['ID']}',uid:'${e['user_id']}',own:'${e['owner']}',fon:'${e['phone']}',
                                  biz:'${e['bizname']}',num:'${e['num']}',mail:'${e['mail']}',
                                  im1:'${e['image1']}',im2:'${e['image2']}',im3:'${e['image3']}',im4:'${e['image4']}',
                                  im5:'${e['image5']}', tit:'${e['title']}',pr:'${e['price']}',desc:'${e['descc']}',adu:'${e['adu']}',
...
void Delete(String s) async{
 ...
 EasyLoading.show(status: 'Deleting .....');
  ...
  var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/rental/delete.php'),
      headers: {"Accept": "headers/json"},
      body:{"pro_id":s});

  if(response.statusCode==200){

    EasyLoading.showSuccess('Apartment deleted...');
