...
import 'package:eazy_landlord/owner/ownerscreens/apartments/pubapart.dart';
...
class AllApart extends StatefulWidget {
  static const  String id='all apart';

  @override
  State<AllApart> createState() => _AllApartState();
}

class _AllApartState extends State<AllApart> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Apartments',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
