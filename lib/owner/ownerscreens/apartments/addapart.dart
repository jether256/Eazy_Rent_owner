...
class AddApart extends StatefulWidget {
  static const  String id='add apart';
  @override
  State<AddApart> createState() => _AddApartState();
}
...
class _AddApartState extends State<AddApart> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Add Apartments ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                ...
                onPressed: () async{
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if( _bedrooms.text!='' && _bathrooms.text!='' && _fun.text!='' && _con.text!='' &&
                        ...
                        && _titleController.text!='' && _descController.text!='' && _placeController.text!=''
                      ...
                      setState(() async {
                        ...
                        var request=http.MultipartRequest('Post',Uri.parse('https://eazyrent256.com/api/owner/addApart.php'));
