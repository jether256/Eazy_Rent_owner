...
class EditBang extends StatefulWidget {
 ...
 final String proi;
  ...
  const EditBang({ required this.Id, required this.uid, required this.own, required this.fon, required this.biz, required this.num, required this.mail, required this.im1, required this.im2, required this.im3, required this.im4, required this.im5, required this.tit, required this.pr, required this.desc, required this.adu, required this.lat, required this.lon, required this.place, required this.bed, required this.bath, required this.fun, required this.con, required this.b, required this.c, required this.flo, required this.kit, required this.paid, required this.start, required this.end, required this.blo, required this.type, required this.proi}) ;

  @override
  State<EditBang> createState() => _EditBangState();
}

class _EditBangState extends State<EditBang> {
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              AppBar(
                ...
                backgroundColor: Colors.blue,
                iconTheme:const IconThemeData(color: Colors.white),
                title: const Text('Number of bathrooms',style: TextStyle(color: Colors.white),),
   ...
   // final _authData = Provider.of<AuthProvider>(context);
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Edit Rentals ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                      ...
                      TextFormField(
                        ...
                        validator: (value){
                          ...
                          if(value!.isEmpty){
                            ...
                            return 'Please enter number of Kitchen';
                          }
              ...
              child: NeumorphicButton(
                ...
                onPressed: () async{
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if( _bedrooms.text!='' && _bathrooms.text!='' && _fun.text!='' && _con.text!='' &&
                        _sqft.text!='' && _carpet.text!='' && _floors.text!=''
                        && _priceController.text !=''
                        && _titleController.text!='' && _descController.text!=''
                        && _placeController.text!='' && _kitchenController.text!=''){
                      ...
                      setState(() async {
                        ...
                        var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/bangalow/updateRental.php'),
