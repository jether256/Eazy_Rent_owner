...
class BangalowList extends StatefulWidget {
  const BangalowList({Key? key}) : super(key: key);

  @override
  State<BangalowList> createState() => _BangalowListState();
}

class _BangalowListState extends State<BangalowList> {
...
String? userID,name,email,num, pass, pic,lon, lat,ad, token,renew,status,type,log,create,cry,uup,fcmi;
  ...
  Future showHouse() async {
    ...
    try{
      ...
      var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/bangalow/getRent.php'),
          body:{'user_id':'$userID'});
            ...
            if(data.contains('empty')){
              ...
              return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No Bangalows Uploaded',style: TextStyle(color: Colors.grey,fontSize: 14),),
                    ...
                    NeumorphicButton(
                      onPressed: (){
                        ...
                        Navigator.pushReplacementNamed(context,AddBang.id);
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Text('Add Bangalow',style: TextStyle(color: Colors.white),),
                          ],
                        ),
                      ),
                    ),
              ...
              return SingleChildScrollView(
                child: DataTable(
                  ...
                  columns: const <DataColumn>[
                    DataColumn(label: Text('Bangalow ')),
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>EditBang(
...
void Delete(String s) async{
  ...
  var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/bangalow/delete.php'),
      headers: {"Accept": "headers/json"},
      body:{"pro_id":s});

  if(response.statusCode==200){

    EasyLoading.showSuccess('Bangalow deleted...');
