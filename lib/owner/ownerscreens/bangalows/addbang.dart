...
class AddBang extends StatefulWidget {
  static const  String id='add bang';
  @override
  State<AddBang> createState() => _AddBangState();
}

class _AddBangState extends State<AddBang> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Add Bangalow ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if( _bedrooms.text!='' && _bathrooms.text!='' && _fun.text!='' && _con.text!='' &&
                      ...
                      setState(() async {
                        ...
                        var request=http.MultipartRequest('Post',Uri.parse('https://eazyrent256.com/api/owner/addBang.php'));
