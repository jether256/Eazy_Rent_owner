...
import 'package:eazy_landlord/owner/ownerscreens/bangalows/pubbang.dart';
...
import '../hostels/pubhost.dart';
import 'addbang.dart';
import 'bangdetail.dart';

class AllBang extends StatefulWidget {

  static const  String id='all bang';

  @override
  State<AllBang> createState() => _AllBangState();
}

class _AllBangState extends State<AllBang> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bangalows',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                ...
                itemBuilder: (context,index){
                  ...
                  return InkWell(
                    onTap: (){
                      ...
                      //
                      Navigator.push(context,MaterialPageRoute(builder: (context)=>BangDetail(
