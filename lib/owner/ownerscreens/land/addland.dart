...
class AddLand extends StatefulWidget {
  static const  String id='add land';
...
class _AddLandState extends State<AddLand> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Add Land ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                      ...
                      TextFormField(
                        ...
                        validator: (value){
                          ...
                          if(value!.isEmpty){
                            ...
                            return 'Please enter number of acres';
                          }
              ...
              child: NeumorphicButton(
                ...
                onPressed: () async{
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if(
                        _sqft.text!='' && _priceController.text !=''
                      ...
                      setState(() async {
                        ...
                        var request=http.MultipartRequest('Post',Uri.parse('https://eazyrent256.com/api/owner/addLand.php'));
