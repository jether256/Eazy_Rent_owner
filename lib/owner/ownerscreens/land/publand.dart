...
class _LandListState extends State<LandList> {
  ...
  Future showHouse() async {
    ...
    try{
      ...
      var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/land/getRent.php'),
          body:{'user_id':'$userID'});
            ...
            if(data.contains('empty')){
              ...
              return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No Land Uploaded',style: TextStyle(color: Colors.grey,fontSize: 14),),
                    ...
                    NeumorphicButton(
                      onPressed: (){
                        ...
                        Navigator.pushReplacementNamed(context,AddLand.id);
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Text('Add Land',style: TextStyle(color: Colors.white),),
                          ],
                        ),
                      ),
                    ),
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>Editland(
...
void Delete(String s) async{
 ...
 // EasyLoading.show(status: 'Deleting .....');
  ...
  var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/land/delete.php'),
      headers: {"Accept": "headers/json"},
      body:{"pro_id":s});

  if(response.statusCode==200){

    EasyLoading.showSuccess('Land deleted...');
