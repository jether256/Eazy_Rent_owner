...
import 'package:eazy_landlord/owner/ownerscreens/land/publand.dart';
...
class AllLand extends StatefulWidget {
  static const  String id='all land';

  @override
  State<AllLand> createState() => _AllLandState();
}

class _AllLandState extends State<AllLand> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Office Space',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
          Padding(
                ...
                itemBuilder: (context,index){
                  ...
                  return InkWell(
                    onTap: (){
                      ...
                      //
                      Navigator.push(context,MaterialPageRoute(builder: (context)=>LandDetail(
