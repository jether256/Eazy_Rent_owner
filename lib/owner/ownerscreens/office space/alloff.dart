...
import 'dart:convert';
import 'package:eazy_landlord/owner/ownerscreens/office%20space/puboffice.dart';
...
import 'officedetail.dart';

class Alloff extends StatefulWidget {
  static const  String id='all off';
                ...
                itemBuilder: (context,index){
                  ...
                  return InkWell(
                    onTap: (){
                      ...
                      //
                      Navigator.push(context,MaterialPageRoute(builder: (context)=>OfficeDetail(
