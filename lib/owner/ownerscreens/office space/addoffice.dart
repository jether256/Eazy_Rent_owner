...
class AddOff extends StatefulWidget {
  static const  String id='add off';
...
class _AddOffState extends State<AddOff> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Add Office Space ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                ...
                onPressed: () async{
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if(  _fun.text!='' && _con.text!='' &&
                        ...
                        && _placeController.text!='' && _placeController.text!=''){
                      ...
                      setState(() async {
                        ...
                        var request=http.MultipartRequest('Post',Uri.parse('https://eazyrent256.com/api/owner/addOff.php'));
