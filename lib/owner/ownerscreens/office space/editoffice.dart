...
class EditOffice extends StatefulWidget {
 ...
 final String proi;
  ...
  const EditOffice({ required this.Id, required this.uid, required this.own, required this.fon, required this.biz, required this.num, required this.mail, required this.im1, required this.im2, required this.im3, required this.im4, required this.im5, required this.tit, required this.pr, required this.desc, required this.adu, required this.lat, required this.lon, required this.place, required this.bed, required this.bath, required this.fun, required this.con, required this.b, required this.c, required this.flo, required this.kit, required this.paid, required this.start, required this.end, required this.blo, required this.type, required this.proi}) ;
...
class _EditOfficeState extends State<EditOffice> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Edit Office ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if(  _fun.text!='' && _con.text!='' &&
                      ...
                      setState(() async {
                        ...
                        var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/office/updateRental.php'),
