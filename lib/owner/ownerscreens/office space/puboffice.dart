...
class _OfficeListState extends State<OfficeList> {
  ...
  Future showHouse() async {
    ...
    try{
      ...
      var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/office/getRent.php'),
          body:{'user_id':'$userID'});
            ...
            if(data.contains('empty')){
              ...
              return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No Office Spaces Uploaded',style: TextStyle(color: Colors.grey,fontSize: 14),),
                    ...
                    NeumorphicButton(
                      onPressed: (){
                        ...
                        Navigator.pushReplacementNamed(context,AddOff.id);
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Text('Add Office Space',style: TextStyle(color: Colors.white),),
                          ],
                        ),
                      ),
                    ),
              ...
              return SingleChildScrollView(
                child: DataTable(
                  ...
                  columns: const <DataColumn>[
                    DataColumn(label: Text('Office Space')),
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>EditOffice(
...
void Delete(String s) async{
 ...
 // EasyLoading.show(status: 'Deleting .....');
  ...
  var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/office/delete.php'),
      headers: {"Accept": "headers/json"},
      body:{"pro_id":s});
  if(response.statusCode==200){

    EasyLoading.showSuccess('Office Space deleted...');
