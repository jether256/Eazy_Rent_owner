...
import 'package:eazy_landlord/owner/ownerscreens/rentals/pubrent.dart';
import 'package:eazy_landlord/owner/ownerscreens/rentals/rentdetail.dart';
...
class AllRentals extends StatefulWidget {
  static const  String id='all rentals';

  @override
  State<AllRentals> createState() => _AllRentalsState();
}

class _AllRentalsState extends State<AllRentals> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Rentals',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
          elevation: 0,
          actions:  [
            Padding(
                ...
                itemBuilder: (context,index){
                  ...
                  return InkWell(
                    onTap: (){
                      ...
                      //
                      Navigator.push(context,MaterialPageRoute(builder: (context)=>RentDetail(
