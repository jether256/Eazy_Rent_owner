...
class AddRental extends StatefulWidget {
  static const  String id='add rental';
...
class _AddRentalState extends State<AddRental> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Add Rentals ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                ...
                if (_fomkey.currentState!.validate()) {
                  ...
                  if( _bedrooms.text!='' && _bathrooms.text!='' && _fun.text!='' && _con.text!='' &&
                      ...
                      setState(() async {
                        ...
                        var request=http.MultipartRequest('Post',Uri.parse('https://eazyrent256.com/api/owner/addRental.php'));
