...
class EditHostel extends StatefulWidget {
 ...
 final String proi;
  ...
  const EditHostel({ required this.Id, required this.uid, required this.own, required this.fon, required this.biz, required this.num, required this.mail, required this.im1, required this.im2, required this.im3, required this.im4, required this.im5, required this.tit, required this.pr, required this.desc, required this.adu, required this.lat, required this.lon, required this.place, required this.bed, required this.bath, required this.fun, required this.con, required this.b, required this.c, required this.flo, required this.kit, required this.paid, required this.start, required this.end, required this.blo, required this.type, required this.proi}) ;
...
class _EditHostelState extends State<EditHostel> {
  ...
  Widget build(BuildContext context) {
   ...
   // final _authData = Provider.of<AuthProvider>(context);
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Edit Hostels ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if( _bedrooms.text!='' && _bathrooms.text!='' && _fun.text!='' && _con.text!='' &&
                      ...
                      setState(() async {
                        ...
                        var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/hostel/updateRental.php'),
