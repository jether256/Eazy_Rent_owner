...
import 'package:eazy_landlord/owner/ownerscreens/hostels/pubhost.dart';
...
import 'hostdetail.dart';
class AllHostel extends StatefulWidget {
  static const  String id='all hostel';

  @override
  State<AllHostel> createState() => _AllHostelState();
}

class _AllHostelState extends State<AllHostel> {
...
@override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('All Hostels',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
          Padding(
                ...
                itemBuilder: (context,index){
                  ...
                  return InkWell(
                    onTap: (){
                      ...
                      //
                      Navigator.push(context,MaterialPageRoute(builder: (context)=>HostelDetail(
