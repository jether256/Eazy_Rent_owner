...
class _HostelListState extends State<HostelList> {
  ...
  Future showHouse() async {
    ...
    try{
      ...
      var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/hostel/getRent.php'),
          body:{'user_id':'$userID'});
            ...
            if(data.contains('empty')){
              ...
              return   Center(
                child: Column(
                  ...
                  children: [
                    const Text('No Hostels Uploaded',style: TextStyle(color: Colors.grey,fontSize: 14),),
                    ...
                    NeumorphicButton(
                      onPressed: (){
                        ...
                        Navigator.pushReplacementNamed(context,AddHostel.id);
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: const [
                            ...
                            Text('Add Hostel',style: TextStyle(color: Colors.white),),
                          ],
                        ),
                      ),
                    ),
                    ...
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            ...
                            {
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>EditHostel(
...
void Delete(String s) async{
  ...
  var response=await http.post(Uri.parse('https://eazyrent256.com/api/owner/businesses/hostel/delete.php'),
  ...
  if(response.statusCode==200){
    ...
    if(userData=="yes"){
      ...
      EasyLoading.showSuccess('Bangalow deleted deleted...');
