...
import 'dart:convert';
import 'package:eazy_landlord/owner/ownerscreens/tourist/pubtour.dart';
import 'package:eazy_landlord/owner/ownerscreens/tourist/tourdetail.dart';
...
class AllTour extends StatefulWidget {
  ...
  static const  String id='all tour';

  @override
  State<AllTour> createState() => _AllTourState();
}

class _AllTourState extends State<AllTour> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tourist B & B',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
