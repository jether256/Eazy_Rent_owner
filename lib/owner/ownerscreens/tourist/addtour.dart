...
class AddTour extends StatefulWidget {
  static const  String id='add Tour';
...
class _AddTourState extends State<AddTour> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        title: const Text('Add Tourist B & B ',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
        elevation: 0,
        actions:  [
                  ...
                  if (_fomkey.currentState!.validate()) {
                    ...
                    if( _bedrooms.text!='' && _bathrooms.text!='' && _fun.text!='' && _con.text!='' &&
                      ...
                      setState(() async {
                        ...
                        var request=http.MultipartRequest('Post',Uri.parse('https://eazyrent256.com/api/owner/addTour.php'));
