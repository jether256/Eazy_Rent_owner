...
class BizSave {
  ...
  BizSave( { required this.id, required this.user_id, required this.logo, required this.shopImage, required this.bizname, required this.phone1, required this.email1, required this.tax, required this.tin, required this.ad, required this.lon,
  ...
  factory BizSave.fromDatabaseJson(Map<String, dynamic> json) =>
      BizSave(
      id:json['ID'],
